function [xy,distance,t_a,minindices] = distance2curve(curvexy,mapxy,interpmethod)
...
%  minindices - array storing the closest segment index to the inquiry
%       points mapxy.
%
%
% Example:
...
minindices=pointdistances.columnindex;
