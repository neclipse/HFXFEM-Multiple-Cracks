...
obj.lcr=4e-1;
obj.dcr=5e-5;               % critical crack displacement where cohesion vanishes (m) from Khoei (2011) 
obj.threshold=3.56e-3;
obj.tmax=4.6e-3;           % Dimensionless parameter to determine if the linear softening begins at the current opening 
% Gc=0.5*tmax*dcr;
