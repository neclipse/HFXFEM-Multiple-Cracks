function snapshot( postprocess, variable, timesteps, varargin)
%SNAPSHOT show snapshots of results from the postprocess
% postprocess is the postdict
...
for istep=1:length(timesteps)
    ...
    post=postprocess(timesteps(istep));
...
%% Commented as the illustration is customized outside this function 052820
% add illustrations
