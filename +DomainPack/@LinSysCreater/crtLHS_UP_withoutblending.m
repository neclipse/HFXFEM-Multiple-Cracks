function crtLHS_UP_withoutblending(obj,newmark,iinc)
...
for ielem=1:length(obj.ElemDict)
    ...
    if ~isempty(ienrich) 
        ...
        obj.ElemDict(ielem).crtstif_enriched_1Dflow(newmark,ienrich,gbinp);
        ...
        % standard element
        obj.ElemDict(ielem).crtstif(newmark,iinc,gbinp);
