function crtstif_enriched_1Dflow( obj, newmark, id , gbinp)
...
% 		wd=wd+inigap;
        kd=(wd)^3/12/muf/1;                        % f=1.24 in [1.04,1.65]
...
%       leading to unsymmetric LHS
        ...
        Hintpsps=Hintpsps-H*DNp'*skin*kd*Md*DNp*ds;
        Hintpspe=Hintpspe-H*DNp'*skin*kd*Md*DNpenr*ds;
        Hintpeps=Hintpeps-H*DNpenr'*skin*kd*Md*DNp*ds;
        Hintpepe=Hintpepe-H*DNpenr'*skin*kd*Md*DNpenr*ds;
        %Sintpsps=Sintpsps-H*Np'*skin*kfi*Np*wd*ds;
        %Sintpspe=Sintpspe-H*Np'*skin*kfi*Npenr*wd*ds;
        %Sintpeps=Sintpeps-H*Npenr'*skin*kfi*Np*wd*ds;
        %Sintpepe=Sintpepe-H*Npenr'*skin*kfi*Npenr*wd*ds;
    end
...
Jpsus=a1*JMat.Qusps';
Jpsue=a1*transpose(JMat.Queps+skin*Qintueps);
...
Jpeus=a1*JMat.Quspe';
Jpeue=a1*transpose(JMat.Quepe+skin*Qintuepe);
